...
HD_PWD='C:/Users/Utilizador/Desktop/Universidade/4_ano/2_semestre/CR/Projeto/ProjetoFinal/MP_ToDisplays/MP_ToDisplays.runs/DebUART_xlconstant_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DebUART_xlconstant_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DebUART_xlconstant_3_0.tcl
