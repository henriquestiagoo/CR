...
HD_PWD='C:/Users/Utilizador/Desktop/Universidade/4_ano/2_semestre/CR/Projeto/ProjetoFinal/MP_ToDisplays/MP_ToDisplays.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DebUART_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DebUART_wrapper.tcl -notrace
