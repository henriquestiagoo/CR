...
HD_PWD='C:/Users/fmcta/Desktop/aula5_ex3/aula5_ex3.runs/ex3_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex3_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex3_blk_mem_gen_0_0.tcl
