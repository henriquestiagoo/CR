...
HD_PWD='C:/Users/Utilizador/Desktop/Universidade/4_ano/2_semestre/CR/Praticas/Aula1/FirstProject/FirstProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VHDL1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VHDL1.tcl -notrace
