...
architecture Behavioral of ex3_5 is
    type for_seg_disp is array (0 to 4) of std_logic_vector(3 downto 0); 
	...
	process(sw, btnU, btnD, btnC, btnL, btnR)
		begin
			if btnU = '1' then
				...
				result <= conv_std_logic_vector((conv_integer(sw(15 downto 8)) / conv_integer(sw(7 downto 0))), 16);
			elsif btnR = '1' then
				result <= conv_std_logic_vector((conv_integer(sw(15 downto 8)) rem conv_integer(sw(7 downto 0))), 16);
			else
