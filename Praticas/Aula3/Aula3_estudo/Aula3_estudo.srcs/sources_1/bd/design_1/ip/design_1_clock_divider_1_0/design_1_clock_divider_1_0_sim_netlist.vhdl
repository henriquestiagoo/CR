...
-- Date        : Sun Apr 02 11:23:55 2017
-- Host        : TiagoHenriques running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Utilizador/Desktop/Universidade/4_ano/2_semestre/CR/Praticas/Aula3/Aula3_estudo/Aula3_estudo.srcs/sources_1/bd/design_1/ip/design_1_clock_divider_1_0/design_1_clock_divider_1_0_sim_netlist.vhdl
...
entity design_1_clock_divider_1_0_clock_divider is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_clock_divider_1_0_clock_divider : entity is "clock_divider";
  attribute how_fast : integer;
  attribute how_fast of design_1_clock_divider_1_0_clock_divider : entity is 15;
end design_1_clock_divider_1_0_clock_divider;

architecture STRUCTURE of design_1_clock_divider_1_0_clock_divider is
  ...
  signal \internal_clock[15]_i_2_n_0\ : STD_LOGIC;
  signal \internal_clock[15]_i_3_n_0\ : STD_LOGIC;
  signal \internal_clock[15]_i_4_n_0\ : STD_LOGIC;
  signal \internal_clock[15]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \internal_clock_reg[15]_i_1_n_1\ : STD_LOGIC;
  signal \internal_clock_reg[15]_i_1_n_2\ : STD_LOGIC;
  signal \internal_clock_reg[15]_i_1_n_3\ : STD_LOGIC;
  signal \internal_clock_reg[15]_i_1_n_4\ : STD_LOGIC;
  signal \internal_clock_reg[15]_i_1_n_5\ : STD_LOGIC;
  signal \internal_clock_reg[15]_i_1_n_6\ : STD_LOGIC;
  signal \internal_clock_reg[15]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \NLW_internal_clock_reg[15]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
begin
...
\internal_clock[15]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\internal_clock[15]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\internal_clock[15]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\internal_clock[15]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\internal_clock_reg[15]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \internal_clock_reg[8]_i_1_n_0\,
      CO(3) => \NLW_internal_clock_reg[15]_i_1_CO_UNCONNECTED\(3),
      CO(2) => \internal_clock_reg[15]_i_1_n_1\,
      CO(1) => \internal_clock_reg[15]_i_1_n_2\,
      CO(0) => \internal_clock_reg[15]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \internal_clock_reg[15]_i_1_n_4\,
      O(2) => \internal_clock_reg[15]_i_1_n_5\,
      O(1) => \internal_clock_reg[15]_i_1_n_6\,
      O(0) => \internal_clock_reg[15]_i_1_n_7\,
      S(3) => \internal_clock[15]_i_2_n_0\,
      S(2) => \internal_clock[15]_i_3_n_0\,
      S(1) => \internal_clock[15]_i_4_n_0\,
      S(0) => \internal_clock[15]_i_5_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_clock_divider_1_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    divided_clk : out STD_LOGIC
  ...
  attribute NotValidForBitStream of design_1_clock_divider_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_clock_divider_1_0 : entity is "design_1_clock_divider_1_0,clock_divider,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_clock_divider_1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_clock_divider_1_0 : entity is "clock_divider,Vivado 2016.4";
end design_1_clock_divider_1_0;

architecture STRUCTURE of design_1_clock_divider_1_0 is
  attribute how_fast : integer;
  attribute how_fast of U0 : label is 15;
begin
U0: entity work.design_1_clock_divider_1_0_clock_divider
     port map (
      clk => clk,
      divided_clk => divided_clk,
      reset => reset
