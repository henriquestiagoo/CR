...
HD_PWD='C:/Users/fmcta/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex3_wrapper.tcl
