...
HD_PWD='C:/Users/fmcta/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex3_wrapper.tcl -notrace
