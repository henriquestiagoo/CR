...
HD_PWD='D:/Users/jgnro/Desktop/UA/4A2S/4A2S/CR/Praticas/03/34-Hamming/34-Hamming.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hamming.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hamming.tcl -notrace
