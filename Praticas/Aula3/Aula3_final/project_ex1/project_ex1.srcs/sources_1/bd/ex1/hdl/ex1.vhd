...
entity ex1 is
  ...
  attribute CORE_GENERATION_INFO of ex1 : entity is "ex1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ex1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of ex1 : entity is "ex1.hwdef";
end ex1;

architecture STRUCTURE of ex1 is
  component ex1_clock_divider_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    divided_clk : out STD_LOGIC
  );
  end component ex1_clock_divider_0_0;
  component ex1_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component ex1_xlconstant_0_0;
  component ex1_Decimal_to_Displays_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component ex1_Decimal_to_Displays_0_0;
  component ex1_contador_0_2 is
  port (
    clk : in STD_LOGIC;
    btnC : in STD_LOGIC;
    sw : in STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  end component ex1_contador_0_2;
  component ex1_BinToBCD16_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    ready : out STD_LOGIC;
  ...
  end component ex1_BinToBCD16_0_0;
...
BinToBCD16_0: component ex1_BinToBCD16_0_0
     port map (
...
Decimal_to_Displays_0: component ex1_Decimal_to_Displays_0_0
     port map (
      an(7 downto 0) => Decimal_to_Displays_0_an(7 downto 0),
      clk => clock_divider_0_divided_clk,
      seg(6 downto 0) => Decimal_to_Displays_0_seg(6 downto 0),
...
clock_divider_0: component ex1_clock_divider_0_0
     port map (
      clk => clk_1,
      divided_clk => clock_divider_0_divided_clk,
      reset => btnC_1
    );
contador_0: component ex1_contador_0_2
     port map (
      btnC => btnC_1,
      clk => clock_divider_0_divided_clk,
