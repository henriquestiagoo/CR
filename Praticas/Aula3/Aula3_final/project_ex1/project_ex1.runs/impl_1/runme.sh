...
HD_PWD='C:/Users/Utilizador/Desktop/Universidade/4_ano/2_semestre/CR/Praticas/Aula3/Aula3_final/project_ex1/project_ex1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex1_wrapper.tcl -notrace
