...
HD_PWD='C:/Users/Utilizador/Desktop/Universidade/4_ano/2_semestre/CR/Praticas/Aula3/Aula3_final/project_ex1/project_ex1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex1_wrapper.tcl
