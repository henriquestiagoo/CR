...
HD_PWD='C:/Users/fmcta/aula3_final/aula3_final.runs/ex1_contador_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex1_contador_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex1_contador_0_2.tcl
