...
HD_PWD='C:/Users/fmcta/Desktop/aula3_ex2/aula3_ex2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex2_wrapper.tcl -notrace
