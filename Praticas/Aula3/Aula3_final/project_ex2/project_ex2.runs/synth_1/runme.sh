...
HD_PWD='C:/Users/fmcta/Desktop/aula3_ex2/aula3_ex2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex2_wrapper.tcl
