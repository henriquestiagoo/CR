...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_wordToRegisto is
  ...
  signal \words_conc[15]_i_1_n_0\ : STD_LOGIC;
begin
...
initial_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\regF[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\words_conc[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
