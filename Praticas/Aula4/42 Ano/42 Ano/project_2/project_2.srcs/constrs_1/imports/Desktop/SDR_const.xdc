...
set_property PACKAGE_PIN N6 [get_ports {sel_disp[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_disp[0]}]
#Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {sel_disp[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_disp[1]}]
#Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {sel_disp[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_disp[2]}]
#Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {sel_disp[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_disp[3]}]
#Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {sel_disp[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_disp[4]}]
#Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {sel_disp[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_disp[5]}]
#Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {sel_disp[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_disp[6]}]
#Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {sel_disp[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_disp[7]}]
